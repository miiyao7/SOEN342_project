...
#[derive(Debug)]
pub enum Train {AVE, EuroCity, Eurostar, Frecciarossa, IC, ICE, InterCity, Intercites, Italo, Nightjet, RE, RJX, Railjet, RegioExpress, TER, TGV, Thalys} impl Train {pub fn as_str(&self) -> &'static str {match self {Train::AVE => "AVE", Train::EuroCity => "EuroCity", Train::Eurostar => "Eurostar", Train::Frecciarossa => "Frecciarossa", Train::IC => "IC", Train::ICE => "ICE", Train::InterCity => "InterCity", Train::Intercites => "Intercités", Train::Italo => "Italo", Train::Nightjet => "Nightjet", Train::RE => "RE", Train::RJX => "RJX", Train::Railjet => "Railjet", Train::RegioExpress => "RegioExpress", Train::TER => "TER", Train::TGV => "TGV", Train::Thalys => "Thalys"}}} impl FromStr for Train {
    type Err = String;
...
#[derive(Debug)]
pub enum Day {Monday, Tuesday, Wednesday, Thursday, Friday, Saturday, Sunday} impl Day {
